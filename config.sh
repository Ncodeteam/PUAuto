...
ODPBG=/storage/emulated/0/Android/data/com.tencent.ig/files/ShadowTrackerExtra/Saved/PAks/ODPaks
...
echo -e "b).some configuration pubg 1.4 to make a good"
echo -e "========================================="
sleep 5
echo "pembersihan"
...
# ODPAKS Remover 
find $ODPBG -type f \( -iname \*.pak \) -exec rm -f {} \; 2>/dev/null
